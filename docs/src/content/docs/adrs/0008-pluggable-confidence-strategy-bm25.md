---
title: "ADR-008: Pluggable `ConfidenceStrategy` with `bm25s` recall"
description: "The orchestrator must decide *how hard* to work each candidate finding: a high-confidence hit"
---
