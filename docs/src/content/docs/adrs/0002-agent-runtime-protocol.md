---
title: "ADR-002: `AgentRuntime` Protocol + adapter (runtime swap)"
description: "ADR-001 commits the substrate to the Claude Agent SDK as the v1 runtime, but explicitly"
---
